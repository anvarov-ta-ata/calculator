...
// v14: слайдер Vercel автоматически читает содержимое папки slides через GitHub,
//     пропуск POST и /api/, пропуск всех внешних доменов
const CACHE_NAME = 'ata-calc-v14';

// База вычисляется от расположения самого sw.js:
// на Vercel   -> '/'
// на GitVerse Pages -> '/assistant/'
...
self.addEventListener('install', event => {
  console.log('[SW] Installing v10, base =', BASE);
  event.waitUntil(
