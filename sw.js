...
// v6: относительные пути (работает и на Vercel, и на GitHub Pages /calculator/),
//     пропуск POST и /api/, пропуск всех внешних доменов
const CACHE_NAME = 'ata-calc-v6';
...
const FILES_TO_CACHE = [
  ...
  'slide13.jpg', 'slide14.jpg', 'slide15.jpg', 'slide16.jpg',
  'slide17.jpg'
].map(f => BASE + f);

// ── УСТАНОВКА ──────────────────────────────────
self.addEventListener('install', event => {
  console.log('[SW] Installing v6, base =', BASE);
  event.waitUntil(
